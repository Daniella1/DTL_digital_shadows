...
public class data_subscriber_kuka : MonoBehaviour
{
    string[] topics = {"actual_q_0","actual_q_1", "actual_q_2", "actual_q_3", "actual_q_4", "actual_q_5", "actual_q_6"};
    ...
    void HandleMessage(string[] message)
    {
        ...
        //Debug.Log("topic: " + topic_index + ", theta: " + theta_val);
        _robotarm_ctrl.UpdateJointTheta(joint_index, theta_val);
        if (joint_index == 6)
            Debug.Log("joint 6, theta: " + theta_val);
